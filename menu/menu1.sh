...
export sem=$( curl -s https://raw.githubusercontent.com/GH-reyz/MultiportV3/main/permission/versions)
...
9) clear ; genssl ;;
10) clear ; jam ;;
6969) clear ; wget https://raw.githubusercontent.com/GH-reyz/MultiportV3/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
